function [BVPSCORE, SCSCORE, TMPSCORE] = comp_SQI_3(blood_volume_pulse,skin_conductance,temperature)
...
for l1 = 1:100:L-W+1
    ...
    temp_sqi(l1:l2)=temp_sqi(l1:l2)*exp(-0.55*dff);
    if temp_min < 20
            temp_sqi(l1:l2) = 0.5*temp_sqi(l1:l2);
    end
    if max(abs(diff(data_in.skt(l1:l2)))) < 0.001
